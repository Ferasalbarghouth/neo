    ...
    public partial class act_list : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            for (int x = 0; x < ds_ma_act.Tables[0].Rows.Count; x++)
            {
                ...
                float total_in = float.Parse(c.sum_quantity_receiving_report_by_mat_type_mat_id_and_date_between("1", dg_mat.Rows[x].Cells[5].Value.ToString(),"r", dt_from.Value.ToString("dd/MM/yyyy"), dt_to.Value.ToString("dd/MM/yyyy")).ToString());
